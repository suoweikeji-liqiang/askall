...
function sendCompletion(text: string) {
    ...
    console.log(`[Qianwen] Request ${currentRequestId} completed (text stable)`);
...
async function fillAndSend(text: string, requestId?: string) {
    ...
    console.log(`[Qianwen] Starting request ${currentRequestId}`);
...
function startResponseMonitor() {
    console.log("[Qianwen] Waiting for AI response...");
